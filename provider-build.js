 let map;
    ...
    // Sort: accepting patients first, then alphabetically by last name, then first name
    providers = [...providers].sort((a, b) => {
        const aAccepting = a['Accepting New Patients'] === 'True';
        const bAccepting = b['Accepting New Patients'] === 'True';
        if (aAccepting !== bAccepting) return aAccepting ? -1 : 1;
        const lastCmp = a['Last Name'].localeCompare(b['Last Name']);
